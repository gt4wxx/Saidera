...
const IMAGES = [
  ...
  "https://images.unsplash.com/photo-1544025162-d76640381a11?w=900&q=80&auto=format&fit=crop",
];
...
const EST_NOMES = [
  ["Bar do Farol", "Atalaia", "bar"],
  ["Point Orla", "Atalaia", "bar"],
  ["Boteco 13", "13 de Julho", "bar"],
  ["Aracaju Beer House", "Coroa do Meio", "bar"],
  ["Bar da Passarela", "Atalaia", "bar"],
  ["Esquina 490", "Farolândia", "bar"],
  ["Chopp Jardins", "Jardins", "bar"],
  ["Bar São José", "São José", "bar"],
  ["Orla Lounge", "Atalaia", "bar"],
  ["Ponto do Caranguejo", "Atalaia", "restaurante"],
  ["Maré Alta", "Coroa do Meio", "bar"],
  ["Boteco do Centro", "Centro", "bar"],
  ["Beer House Siqueira", "Siqueira Campos", "bar"],
  ["Casa do Malte", "Jardins", "bar"],
  ["Deck da Orla", "Atalaia", "bar"],
  ["Bar da Lua", "Coroa do Meio", "bar"],
  ["Empório 13", "13 de Julho", "restaurante"],
  ["Tap Room Grageru", "Grageru", "bar"],
  ["Cervejaria Luzia", "Luzia", "bar"],
  ["Bar do Trapiche", "Centro", "bar"],
  ["Quintal da Cerveja", "Farolândia", "bar"],
  ["Noite Serena", "Jardins", "bar"],
  ["Bar da Esquina", "Siqueira Campos", "bar"],
  ["Lounge Atlântico", "Atalaia", "bar"],
  ["Copo Cheio", "Ponto Novo", "bar"],
  ["Bar Farolândia", "Farolândia", "bar"],
  ["Mesa 10", "13 de Julho", "restaurante"],
  ["Pub do Morro", "São José", "bar"],
  ["Taverna Tropical", "Coroa do Meio", "bar"],
  ["Bar da Ponte", "Centro", "bar"],
  ["Happy Hour 490", "Farolândia", "bar"],
  ["Chopeira do Centro", "Centro", "bar"],
  ["Vila do Malte", "Grageru", "bar"],
  ["Bar da Praça", "Luzia", "bar"],
  ["Sunset Atalaia", "Atalaia", "bar"],
  ["Bar do Mercado", "Centro", "bar"],
  ["Canto da Orla", "Atalaia", "bar"],
  ["Boteco da Luzia", "Luzia", "bar"],
  ["Casa Jardins", "Jardins", "restaurante"],
  ["Ponto 13", "13 de Julho", "bar"],
  ["Bar do Porto", "Coroa do Meio", "bar"],
  ["Litoral Beer", "Atalaia", "bar"],
  ["Bar da Folia", "São José", "bar"],
  ["Estação Chopp", "Siqueira Campos", "bar"],
  ["Bar do Beco", "Centro", "bar"],
  ["Orla 300", "Atalaia", "bar"],
  ["Malte & Mar", "Coroa do Meio", "bar"],
  ["Bar da Areia", "Atalaia", "bar"],
  ["Clube da Tampa", "Jardins", "bar"],
  ["Boteco Farol", "Atalaia", "bar"],
  ["Jardins Pub", "Jardins", "bar"],
  ["Bar do Sol", "Inácio Barbosa", "bar"],
  ["Coroa Lounge", "Coroa do Meio", "bar"],
  ["Sabor e Chopp", "Grageru", "bar"],
  ["Bar da Palmeira", "Luzia", "bar"],
  ["Noite Dourada", "13 de Julho", "bar"],
  ["Ponto do Malte", "Farolândia", "bar"],
  ["Bar Recanto", "Ponto Novo", "bar"],
  ["Atalaia Deck", "Atalaia", "bar"],
  ["Cerveja & Cia", "Siqueira Campos", "bar"],
  ["Moqueca da Orla", "Atalaia", "restaurante"],
  ["Caranguejo do Farol", "Atalaia", "restaurante"],
  ["Peixada da Coroa", "Coroa do Meio", "restaurante"],
  ["Marisqueira Beira Mar", "Atalaia", "restaurante"],
  ["Camarão na Moranga", "Atalaia", "restaurante"],
  ["Sabor de Sergipe", "Centro", "restaurante"],
  ["Casa do Baião", "13 de Julho", "restaurante"],
  ["Restaurante Trapiche", "Centro", "restaurante"],
  ["Panelinha Nordestina", "Luzia", "restaurante"],
  ["Mangaba & Mel", "Coroa do Meio", "restaurante"],
  ["Fogão de Lenha", "Siqueira Campos", "restaurante"],
  ["Churrascaria Boi na Brasa", "Farolândia", "restaurante"],
  ["Costela no Bafo", "Grageru", "restaurante"],
  ["Filé na Pedra", "Jardins", "restaurante"],
  ["Galeto da Esquina", "Ponto Novo", "restaurante"],
  ["Pizzaria da Orla", "Atalaia", "restaurante"],
  ["La Pasta Jardins", "Jardins", "restaurante"],
  ["Cantina 13", "13 de Julho", "restaurante"],
  ["Tasca Portuguesa", "13 de Julho", "restaurante"],
  ["Temakeria Atalaia", "Atalaia", "restaurante"],
  ["Sushi da Orla", "Atalaia", "restaurante"],
  ["Poke da Coroa", "Coroa do Meio", "restaurante"],
  ["Burger House 490", "Farolândia", "restaurante"],
  ["Espetto Carioca", "Ponto Novo", "restaurante"],
  ["Bistrô Luzia", "Luzia", "restaurante"],
  ["Wine Bar Jardins", "Jardins", "bar"],
  ["Rooftop Atalaia", "Atalaia", "bar"],
  ["Irish Pub SE", "Jardins", "bar"],
  ["Bar da Duna", "Atalaia", "bar"],
  ["Bar do Cais", "Coroa do Meio", "bar"],
  ["Boteco do Gago", "Farolândia", "bar"],
  ["Pub 13", "13 de Julho", "bar"],
  ["Mezcal & Lima", "13 de Julho", "bar"],
  ["Hop Lab Grageru", "Grageru", "bar"],
  ["Bar da Feira", "Centro", "bar"],
  ["Samba e Cerveja", "Centro", "bar"],
  ["Bar do Vizinho", "Siqueira Campos", "bar"],
  ["Bar da Varanda", "São José", "bar"],
  ["Bar da Lagoa", "Inácio Barbosa", "bar"],
  ["After Hours Orla", "Atalaia", "bar"],
  ["Chopeira Jardins", "Jardins", "bar"],
  ["Cervejaria da Ponte", "Centro", "bar"],
  ["Restaurante do Mercado", "Centro", "restaurante"],
  ["Casa da Tapioca", "Centro", "restaurante"],
  ["Grill Inácio", "Inácio Barbosa", "restaurante"],
  ["Restaurante São José", "São José", "restaurante"],
  ["Empório Jardins", "Jardins", "restaurante"],
  ["Parmegiana 13", "13 de Julho", "restaurante"],
  ["Carne de Sol Luzia", "Luzia", "restaurante"],
  ["Quiosque da Orla", "Atalaia", "restaurante"],
  ["Lagosta Blue", "Atalaia", "restaurante"],
  ["Bar da Mangueira", "Luzia", "bar"],
  ["Boteco 490", "Farolândia", "bar"],
  ["Night Deck Farol", "Atalaia", "bar"],
  ["Pub do Porto", "Coroa do Meio", "bar"],
  ["Tapiocaria da Praia", "Atalaia", "restaurante"],
  ["Acarajé da Coroa", "Coroa do Meio", "restaurante"],
  ["Picanha do Grageru", "Grageru", "restaurante"],
  ["Cantinho Mineiro", "Farolândia", "restaurante"],
];
...
const estabelecimentos = EST_NOMES.map(([nome, bairroNome, tipoNome], i) => {
  const bairro = BAIRROS.find((b) => b.nome === bairroNome) || BAIRROS[i % BAIRROS.length];
  const tipo = tipoNome || "bar";
  const metaPadrao = 10;
...
for (let i = 3; i < clientes.length; i++) {
  ...
  for (let p = 0; p < nPlaces; p++) {
    let est = estabelecimentos[randInt(0, estabelecimentos.length - 1)];
