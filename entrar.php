...
<head>
  ...
  <link rel="stylesheet" href="assets/css/client.css?v=16"/>
...
<body>
  <main class="landing">
    ...
    <section class="card pad" id="entrar-card" style="max-width:440px;margin:0 auto 24px">
      <div class="entrar-tabs">
        <button type="button" class="chip on" data-entrar-tab="login">Entrar</button>
        <button type="button" class="chip" data-entrar-tab="cadastro">Cadastrar</button>
      </div>
      <form id="form-login">
  ...
  <script src="assets/js/icons.js?v=16"></script>
  <script src="assets/js/api.js?v=16"></script>
  <script src="assets/js/ui.js?v=16"></script>
  <script src="assets/js/entrar.js?v=16"></script>
</body>
</html>
