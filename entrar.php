...
<head>
  ...
  <link rel="stylesheet" href="assets/css/client.css?v=23"/>
  ...
  <script src="assets/js/pwa-captura.js?v=23"></script>
</head>
<body>
  <main class="landing">
  ...
  <script src="assets/js/icons.js?v=23"></script>
  <script src="assets/js/api.js?v=23"></script>
  <script src="assets/js/ui.js?v=23"></script>
  <script src="assets/js/entrar.js?v=23"></script>
</body>
</html>
