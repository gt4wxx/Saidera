...
<head>
  ...
  <link rel="stylesheet" href="assets/css/client.css?v=18"/>
...
<body>
  <main class="landing">
    ...
    <section class="card pad" id="entrar-card" style="max-width:440px;margin:0 auto 24px">
      <div class="entrar-tabs" id="entrar-tabs">
        <a class="chip on" href="#login" data-entrar-tab="login">Entrar</a>
        <a class="chip" href="#cadastro" data-entrar-tab="cadastro">Cadastrar</a>
      </div>
      <form id="form-login" class="entrar-pane on">
        <h2 style="margin:12px 0">Entrar</h2>
        ...
        <p class="tiny muted" style="margin-top:12px;text-align:center">Não tem conta? <a href="#cadastro" data-entrar-tab="cadastro" style="color:#F5B800">Cadastrar</a></p>
      </form>
      <form id="form-cadastro" class="entrar-pane">
        <h2 style="margin:12px 0">Criar conta</h2>
        ...
        <p class="tiny muted" style="margin-top:12px;text-align:center">Já tem conta? <a href="#login" data-entrar-tab="login" style="color:#F5B800">Entrar</a></p>
      </form>
  ...
  <script src="assets/js/icons.js?v=18"></script>
  <script src="assets/js/api.js?v=18"></script>
  <script src="assets/js/ui.js?v=18"></script>
  <script src="assets/js/entrar.js?v=18"></script>
</body>
</html>
